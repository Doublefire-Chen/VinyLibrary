...
interface LoginRequiredProps {
    redirectDelay?: number; // Delay in milliseconds before redirect
        ...
        <div className="min-h-screen bg-[#f8f6f1] text-[#2e2e2e] font-serif flex items-center justify-center">
            <div className="bg-white rounded-2xl shadow-xl border border-[#c9b370] py-12 px-8 text-center max-w-md">
                ...
                <h1 className="text-2xl font-bold text-[#1a1a1a] mb-3">
                    {c('login_required') || 'Login Required'}
                </h1>
                <p className="text-[#666] mb-4">
                    {message || c('login_required_message') || 'You need to be logged in to access this page.'}
                </p>
                <p className="text-sm text-[#888] mb-4">
                    {c('redirecting_in') || 'Redirecting to login page in'} {countdown} {c('seconds')}...
                </p>
                <div className="mt-4">
                    <Link
                        href="/login"
